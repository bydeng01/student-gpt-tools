...
| [Humanize-Text](https://github.com/lynote-ai/humanize-text)<br> [![GitHub Repo](https://img.shields.io/badge/Repo-humanize--text-blue)](https://github.com/lynote-ai/humanize-text) [![GitHub stars](https://img.shields.io/github/stars/lynote-ai/humanize-text.svg?style=social&label=Star)](https://github.com/lynote-ai/humanize-text) | Free (open-source); API keys required for the full pipeline. | Open-source AI text humanizer with a multilingual rewriting pipeline for making AI-generated drafts sound more natural. |
...
| [AI Text Detector](https://github.com/lynote-ai/ai-text-detector)<br> [![GitHub Repo](https://img.shields.io/badge/Repo-ai--text--detector-blue)](https://github.com/lynote-ai/ai-text-detector) [![GitHub stars](https://img.shields.io/github/stars/lynote-ai/ai-text-detector.svg?style=social&label=Star)](https://github.com/lynote-ai/ai-text-detector) | Free (open-source); local only. | Explainable local AI-text risk analyzer with cautious scoring, short-text guardrails, and review-oriented output. |
...
| [StudyArena](https://studyarena.com) | Free three-model comparisons; paid model choice and six-model comparisons. | Compare three anonymous answers to a study question, vote for the most useful explanation, then reveal the models. |
...
| Name | Cost | Description |
| --- | --- | --- |
| [Wolfram](https://chatgpt.com/g/g-0S5FXLyFN-wolfram) |Available for free users with limited access; account required. \<GPTs\> | Access computation, math, curated knowledge & real-time data from Wolfram \| Alpha and Wolfram Language; from the makers of [Mathematica](https://www.wolfram.com/mathematica/). |
|[Math Solver](https://chatgpt.com/g/g-9YeZz6m6k-math-solver) | Available for free users with limited access; account required. \<GPTs\> | Your AI Math Solver, offers step-by-step answers, and helps you learn math and even all subjects, at any educational level.|
|[math](https://chatgpt.com/g/g-WP1diWHRl-math) | Available for free users with limited access; account required. \<GPTs\> | The worlds most powerful math tool. [$PULSR](https://pulsr.co.uk/) |
|[physics](https://chatgpt.com/g/g-KMujTLNVK-physics) | Available for free users with limited access; account required. \<GPTs\> | The worlds most powerful Physics tool. [$PULSR](https://pulsr.co.uk/) |
...
| [AI Language Tutors: Learn Spanish, German, French](https://chatgpt.com/g/g-P1X8o6foR-ai-language-tutors-learn-spanish-german-french) | Available for free users with limited access; account required. \<GPTs\> | Welcome to the 28 Language Learning Tutors! Here, you can learn and practice over 28 different languages, whether you are a beginner or an advanced learner. |
|[SpeakPal-Your private AI Language Teacher](https://chatgpt.com/g/g-huBIQBYXM-speakpal-your-private-ai-language-teacher)| Available for free users with limited access; account required. \<GPTs\> |Supports 20+ languages - Spanish, German, French, English, Chinese, Korean, Japanese, ... the GPT will increase your vocabulary by talking about fun topics, coach you. |
| [HelloTalk Learn Languages](https://chatgpt.com/g/g-GbU30tkTv-hellotalk-learn-languages) | Available for free users with limited access; account required. \<GPTs\> | Learn more than 50 languages for free using your native language.Learn English through texting people on Duolingo HelloTalk, italki, etc.Estimates test scores, offers practice and guidance. |
...
| [DeepAnalyze](https://github.com/ruc-datalab/DeepAnalyze) <br> [![GitHub Repo](https://img.shields.io/badge/Repo-DeepAnalyze-blue)](https://github.com/ruc-datalab/DeepAnalyze) [![GitHub stars](https://img.shields.io/github/stars/ruc-datalab/DeepAnalyze.svg?style=social&label=Star)](https://github.com/ruc-datalab/DeepAnalyze) | Free (open-source) | DeepAnalyze is the first agentic LLM for autonomous data science. |
...
| [Google Antigravity](https://antigravity.google/) | Currently public preview, check [pricing](https://antigravity.google/pricing); Google account required. | Experience liftoff with the next-generation IDE. |
...
| [Code Wiki](https://codewiki.google/) | Public preview. | A new perspective on development for the agentic era. Gemini-generated documentation, always up-to-date. |
...
| [FigPad](https://figpad.ai/) | Account required; pricing and credits vary. | AI workspace for creating scientific figures from prompts, sketches, and reference images, with editable SVG/PPTX export for papers, posters, and slides. |
